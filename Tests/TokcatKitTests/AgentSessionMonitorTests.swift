...
final class AgentSessionMonitorTests: XCTestCase {
    ...
    func testBootstrapNoAlertsThenLiveCompletionPersistsUnreadAcrossRestart() throws {
        ...
        let monitor = AgentSessionMonitor(codexDirectory: logs, supportDirectory: support, now: now, recentRoots: [], workBuddyDatabase: nil)
        ...
        let restarted = AgentSessionMonitor(codexDirectory: logs, supportDirectory: support, recentRoots: [], workBuddyDatabase: nil)
        ...
        let again = AgentSessionMonitor(codexDirectory: logs, supportDirectory: support, recentRoots: [], workBuddyDatabase: nil)
